...
export async function middleware(request: NextRequest) {
    ...
    if (publicPaths.includes(path) || path.startsWith('/api/auth') || path.startsWith('/api/register') || path.startsWith('/api/system') || path.startsWith('/_next') || path.startsWith('/favicon.ico') || path.startsWith('/manifest.json') || path.endsWith('.png') || path.endsWith('.jpg') || path.endsWith('.svg')) {
