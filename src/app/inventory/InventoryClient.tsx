...
// ... (rest of form code unchanged, skipped for brevity in tool call if possible, but replace_file_content needs contigous block. I will just target the header part first to be safe, then the table part separate)

                    // ACTION: I will split this into two calls for safety.
                    // 1. Header Update
                    // 2. Table Update (Undo)
